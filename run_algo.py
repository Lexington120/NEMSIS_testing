...
# # Print out the numbered names of the element groups
# print(names)
# print()

# print(allElements[0].findall('*'))
# test = allElements[0].findall('*')
# print(type(test[0]) == type(test[1]))

# print()
# print(test[0].tag[(25+len(names[0])):])
# print(test[0].tag[(25+len(names[0])):].isnumeric())
# print(test[1].tag[(25+len(names[0])):])
# print(test[1].tag[(25+len(names[0])):].isnumeric())
# print(int(test[0].tag[(25+len(names[0])):]))
